...
if (isset($_SESSION['login']) && $_SESSION['full_path'] == realpath(".") )			// logged in
{
    ...
    {
        show_links($left_links=array("View Log", "advanced.php?op=view_log", "Rendezvous History", "advanced.php?op=ren_hist",
    ...
    {
        show_links($left_links=array("Rendezvous History", "advanced.php?op=ren_hist"),
